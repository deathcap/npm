;(function () {
  ...
  Object.keys(abbrevs).concat(plumbing).forEach(function addCommand (c) {
    Object.defineProperty(npm.commands, c, { get: function () {
      ...
      var cmd;
      if (a === 'access') cmd = require('./access')
      else if (a === 'adduser') cmd = require('./adduser')
      else if (a === 'bin') cmd = require('./bin')
      else if (a === 'bugs') cmd = require('./bugs')
      else if (a === 'build') cmd = require('./build')
      else if (a === 'cache') cmd = require('./cache')
      else if (a === 'cache') cmd = require('./cache')
      else if (a === 'completion') cmd = require('./completion')
      else if (a === 'config') cmd = require('./config')
      else if (a === 'config') cmd = require('./config')
      else if (a === 'dedupe') cmd = require('./dedupe')
      else if (a === 'deprecate') cmd = require('./deprecate')
      else if (a === 'dist-tag') cmd = require('./dist-tag')
      else if (a === 'docs') cmd = require('./docs')
      else if (a === 'edit') cmd = require('./edit')
      else if (a === 'explore') cmd = require('./explore')
      else if (a === 'fetch-package-metadata') cmd = require('./fetch-package-metadata')
      else if (a === 'get') cmd = require('./get')
      else if (a === 'help-search') cmd = require('./help-search')
      else if (a === 'help') cmd = require('./help')
      else if (a === 'init') cmd = require('./init')
      else if (a === 'install') cmd = require('./install')
      else if (a === 'install-test') cmd = require('./install-test')
      else if (a === 'install') cmd = require('./install')
      else if (a === 'link') cmd = require('./link')
      else if (a === 'logout') cmd = require('./logout')
      else if (a === 'ls') cmd = require('./ls')
      else if (a === 'npm') cmd = require('./npm')
      else if (a === 'outdated') cmd = require('./outdated')
      else if (a === 'owner') cmd = require('./owner')
      else if (a === 'pack') cmd = require('./pack')
      else if (a === 'ping') cmd = require('./ping')
      else if (a === 'prefix') cmd = require('./prefix')
      else if (a === 'prune') cmd = require('./prune')
      else if (a === 'publish') cmd = require('./publish')
      else if (a === 'rebuild') cmd = require('./rebuild')
      else if (a === 'repo') cmd = require('./repo')
      else if (a === 'restart') cmd = require('./restart')
      else if (a === 'root') cmd = require('./root')
      else if (a === 'run-script') cmd = require('./run-script')
      else if (a === 'search') cmd = require('./search')
      else if (a === 'set') cmd = require('./set')
      else if (a === 'shrinkwrap') cmd = require('./shrinkwrap')
      else if (a === 'star') cmd = require('./star')
      else if (a === 'stars') cmd = require('./stars')
      else if (a === 'start') cmd = require('./start')
      else if (a === 'stop') cmd = require('./stop')
      else if (a === 'substack') cmd = require('./substack')
      else if (a === 'tag') cmd = require('./tag')
      else if (a === 'team') cmd = require('./team')
      else if (a === 'test') cmd = require('./test')
      else if (a === 'unbuild') cmd = require('./unbuild')
      else if (a === 'uninstall') cmd = require('./uninstall')
      else if (a === 'unpublish') cmd = require('./unpublish')
      else if (a === 'update') cmd = require('./update')
      //else if (a === 'utils') cmd = require('./utils')
      else if (a === 'version') cmd = require('./version')
      else if (a === 'view') cmd = require('./view')
      else if (a === 'visnup') cmd = require('./visnup')
      else if (a === 'whoami') cmd = require('./whoami')
      else if (a === 'xmas') cmd = require('./xmas')
      else throw new Error('unrecognized npm command: ' + cmd);
